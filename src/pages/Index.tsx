...
import { BarChart3, Shield, Users, Database, Brain, Globe, ChevronRight, LogIn, BookOpen, GraduationCap, FileText, TrendingUp, ArrowLeft, ArrowRight, Menu, X } from "lucide-react";
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-3">
              ...
              <div className="hidden sm:block">
                <h1 className="text-lg font-semibold text-ds-text-primary">Government of Sharjah</h1>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="max-w-4xl mx-auto space-y-6 mb-12">
            <p className="text-lg sm:text-xl lg:text-2xl text-ds-text-secondary font-medium">
              Aligned with the vision of the Sharjah Council for Higher Education 
              and Scientific Research to elevate academic quality and institutional excellence
            </p>
            <p className="text-base sm:text-lg text-ds-text-muted leading-relaxed">
              Transform higher education data management and governance in Sharjah through 
              intelligent automation, evidence-based decision making, and seamless institutional integration.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-12 space-y-4 sm:space-y-0">
            <h2 className="text-2xl sm:text-3xl font-bold text-ds-text-primary">Featured Services</h2>
            ...
            <div className="w-full max-w-md">
              <Link to="/institution/onboarding">
                <HorizontalServiceCard
                  ...
                  icon={Users}
                  onCardClick={() => console.log('Institution onboarding clicked')}
                />
              </Link>
            </div>
          </div>
      ...
      <section className="py-16 bg-ds-bg-grey">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold text-ds-text-primary mb-4">Platform Objectives</h2>
            <p className="text-base sm:text-lg text-ds-text-secondary max-w-3xl mx-auto">
              Our comprehensive platform is designed to transform higher education data management 
              and governance in Sharjah through four key strategic objectives.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <Card className="border border-ds-border hover:shadow-lg transition-shadow bg-white hover-lift">
              <CardHeader className="pb-4">
                ...
                <CardTitle className="text-xl text-ds-text-primary">Strengthen Decision-Making</CardTitle>
                <CardDescription className="text-ds-text-secondary">
                  Policy formulation and institutional improvement using accurate, comprehensive, and timely data
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="border border-ds-border hover:shadow-lg transition-shadow bg-white hover-lift">
              <CardHeader className="pb-4">
                ...
                <CardTitle className="text-xl text-ds-text-primary">High-Quality Data Standards</CardTitle>
                <CardDescription className="text-ds-text-secondary">
                  Promote data excellence to meet local and international academic benchmarks
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="border border-ds-border hover:shadow-lg transition-shadow bg-white hover-lift">
              <CardHeader className="pb-4">
                ...
                <CardTitle className="text-xl text-ds-text-primary">Seamless Integration</CardTitle>
                <CardDescription className="text-ds-text-secondary">
                  Institution-friendly data sharing that works autonomously with existing systems—eliminating redundancy and minimizing manual effort
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="border border-ds-border hover:shadow-lg transition-shadow bg-white hover-lift">
              <CardHeader className="pb-4">
                ...
                <CardTitle className="text-xl text-ds-text-primary">Actionable Intelligence</CardTitle>
                <CardDescription className="text-ds-text-secondary">
                  Transform data into insights—enabling evidence-based policy and enhanced institutional decision-making, performance tracking, and academic planning
                </CardDescription>
              </CardHeader>
            </Card>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-base sm:text-lg text-ds-text-secondary mb-8">
            Join the Smart Education Governance Platform and be part of Sharjah's vision for academic excellence 
            through intelligent data management and evidence-based decision making.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-ds-text-muted">
                <li><a href="#" className="hover:text-white transition-colors">Institution Onboarding</a></li>
